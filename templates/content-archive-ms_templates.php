		...
		<div class="Category__content">
			...
			<ul class="Category__content__items list">
				...
				while ( have_posts() ) :
					...
					<li class="Category__item Category__item--blogLike <?= esc_attr( $category ); ?> <?= esc_attr( $category_en ); ?>" data-category="<?= esc_attr( $category ); ?>" data-href="<?php the_permalink(); ?>" onclick="_paq.push(['trackEvent', 'Activity', 'Templates', 'Go to <?= esc_html( $postname ); ?> article'])">
