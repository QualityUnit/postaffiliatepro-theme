		...
		<div class="Archive__header__filter">
			...
			<div class="Archive__header__dropdown">
				<button class="dropdown">
					<span><?php _e( 'Category', 'ms' ); ?></span>
					<img src="<?= esc_url( get_template_directory_uri() ); ?>/assets/images/icon-arrow.svg" alt="<?php _e( 'dropdown arrow', 'ms' ); ?>">
				</button>
				<div class="Archive__header__dropdown--menu">
					<ul>
						<?php foreach ( $categories as $category ) { ?>
							<li><a href="#<?= esc_attr( $category->slug ); ?>" title="<?= esc_attr( $category->name ); ?>"><?= esc_html( $category->slug ); ?></a></li>
						<?php } ?>
					</ul>
				</div>
			</div>
