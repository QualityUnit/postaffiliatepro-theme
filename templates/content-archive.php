	...
	<div class="Blog__container wrapper">
		<ul class="Blog__items">
			...
			while ( $show_other_posts->have_posts() ) :
				...
				?>
				<li itemprop="blogPost" itemscope itemtype="http://schema.org/BlogPosting" <?php post_class( 'Blog__item Box--shadow Box--article' ); ?>>
					<a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>" itemprop="url">
						...
						<div class="Blog__item__content Box--article__text">
							...
							<p class="Box--article__more">
								<?php _e( 'Learn more' ); ?>
								<svg class="Box--article__more-arrow" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19 19" ><g><path d="M16.662 8.404H0v2.192h16.662V8.404z"/><path d="M17.484 7.903 7.976 17.41l1.55 1.55 9.508-9.507-1.55-1.55z"/><path d="m9.558-.003-1.55 1.55 9.508 9.508 1.55-1.55L9.558-.003z"/></g></svg>
							</p>
						</div>
					</a>
				</li>
