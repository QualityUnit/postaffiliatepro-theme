...
set_source( 'videos', 'filterNew', 'js' );
...
<div id="category" class="Category">
	...
	<div class="wrapper Category__container">
		<div class="Category__content wide">
			<ul class="Category__content__items list" data-list>
				...
				while ( have_posts() ) :
					...
					<li class="Category__item Category__item--videos Category__item--blogLike" data-listitem data-category="<?= esc_attr( $category ); ?>" data-href="<?php the_permalink(); ?>">
