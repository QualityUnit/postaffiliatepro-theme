						...
						<div class="AffiliateManagers">
							...
							foreach ( $managers as $manager ) {
								...
								if ( ! isset( $picture ) || '' === $picture ) {
									$picture = get_avatar( get_term_meta( $taxonomy_id, 'email', true ), $size = '188', $default = "' . esc_url( get_template_directory_uri() ) . '/assets/images/affiliate_manager_avatar.svg'" );
								}
