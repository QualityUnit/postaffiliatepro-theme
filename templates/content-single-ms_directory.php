		...
		<div class="Post__content">
			...
			<div class="Content">
				...
				if ( preg_match( '/\<img/', $screenshot ) ) {
					?>
				<a class="Directory__screenshot urlslab-skip-lazy" style="max-height: 435px" href="<?= esc_url( get_post_meta( get_the_ID(), 'company_url', true ) ); ?>" target="_blank" title="<?= esc_attr( __( 'Go to', 'ms' ) . ' ' . get_post_meta( get_the_ID(), 'company_url', true ) ); ?>"
