	...
	<nav class="ContactUs__menu--wrap hidden" data-targetId="contactUsMenu" data-hide-delay="500">
		...
		<div class="ContactUs__status">
			...
			<div class="ContactUs__status--info" id="contactUsStatus">
				<a href="https://status.postaffiliatepro.com/" target="_blank" class="ContactUs__status ok" data-status="ok"><?php _e( 'Servers online', 'contactus' ); ?></a>
				<a href="https://status.postaffiliatepro.com/" target="_blank" class="ContactUs__status outage" data-status="outage"><?php _e( 'Servers offline', 'contactus' ); ?></a>
				...
				<a href="https://status.postaffiliatepro.com/" target="_blank" class="ContactUs__status unavailable" data-status="unavailable"><?php _e( 'Status unavailable', 'contactus' ); ?></a>
			</div>
		</div>
