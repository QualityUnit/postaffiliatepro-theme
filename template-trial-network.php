	...
	<div class="Trial__container">
		<div class="Trial__sidebar urlslab-min-width-1024">
			<div class="Trial__sidebar__inner">
				...
				<p class="Trial__sidebar__title"><?php esc_html_e( 'Over 10,000 affiliate programs powered by Post Affiliate Network™ and counting!', 'ms' ); ?></p>
					<h3 class="Trial__sidebar__checklist__title"><?php esc_html_e( 'What you will get', 'ms' ); ?></h3>
					<ul>
						<li><?php esc_html_e( 'Unlimited affiliates and multiple merchant accounts', 'ms' ); ?></li>
						<li><?php esc_html_e( 'Full control over network customization', 'ms' ); ?></li>
						<li><?php esc_html_e( 'Free setup, web integration, and lifetime updates', 'ms' ); ?></li>
					</ul>
				...
				<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/trial_sidebar_affiliate_network.png" alt="<?php esc_attr_e( 'affiliate program', 'ms' ); ?>" class="urlslab-skip-lazy">
				</div>
			</div>
		</div>
		<div class="Trial__main">
			...
			<div class="Trial__main__inner">
				<div class="Trial__main__tabs flex">
					<a href="<?php esc_url( '/trial/', 'ms' ); ?>" class="Button Button--outline Button--outline-light Button--narrow Button--icon">
					...
					<a href="<?php esc_url( '/network/trial/', 'ms' ); ?>" class="Button Button--narrow Button--full Button--icon">
				...
				<h1 class="Trial__main__title"><?php esc_html_e( 'Try Our 14-Day <span class="highlight-background">Free Trial</span>', 'ms' ); ?></h1>
				<p class="Trial__main__text"><?php esc_html_e( 'Sign up for Post Affiliate Network in less than 60 seconds. Enjoy testing every feature from our All-Inclusive plan starting today.', 'ms' ); ?></p>
				<div class="Signup__form__labels Trial__labels">
					<div class="Signup__form__labels__label"><?php esc_html_e( '14-day free trial', 'ms' ); ?></div>
				...
				<div class="Trial__main__logos">
					<div class="Trial__main__logo">
						<a href="<?php esc_url( '/awards/', 'ms' ); ?>">
							<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/rating_capterra.svg" alt="<?php esc_attr_e( 'Capterra', 'ms' ); ?>" class="urlslab-skip-lazy">
						</a>
					</div>

					<div class="Trial__main__logo">
						<a href="<?php esc_url( '/awards/', 'ms' ); ?>">
							<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/rating_g2.svg" alt="<?php esc_attr_e( 'G2 Crowd', 'ms' ); ?>" class="urlslab-skip-lazy">
						</a>
					</div>
				</div>
			</div>
