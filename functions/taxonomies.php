<?php
	...
	require_once get_template_directory() . '/lib/taxonomies/integrations-types.php';
	...
	require_once get_template_directory() . '/lib/taxonomies/successstories-categories.php';
