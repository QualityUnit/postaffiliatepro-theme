		...
		<div class="slider splide">
			<div class="splide__track">
				<div class="splide__list">
					<div class="splide__slide FullScreen__sidebar__item FullScreen__sidebar__item--demo" style="background-image: url(https://dd992yotdmnlu.cloudfront.net/app/uploads/2020/01/bg_demo_michaela.jpg);">
					...
					<div class="splide__slide FullScreen__sidebar__item FullScreen__sidebar__item--demo" style="background-image: url(https://dd992yotdmnlu.cloudfront.net/app/uploads/2020/01/bg_demo_tomas.jpg);">
						<div class="FullScreen__sidebar__item__text">
					...
					<div class="splide__slide FullScreen__sidebar__item FullScreen__sidebar__item--demo" style="background-image: url(https://dd992yotdmnlu.cloudfront.net/app/uploads/2020/01/bg_demo_andrej.jpg);">
						<div class="FullScreen__sidebar__item__text">
