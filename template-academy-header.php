								...
								<div class="elementor-widget-container">
									<div class="elementor-image">
										<img style="opacity: 0; transition: opacity 0.5s ease 0s;" class="attachment-large size-large"
											...
											data-lasrc="https://dd992yotdmnlu.cloudfront.net/app/uploads/2021/06/helpdesk-2.svg">
									</div>
								</div>
							</div>
								...
								<div class="elementor-widget-container">
									<div class="elementor-image">
										<img width="970" height="1024" style="opacity:0; transition: opacity 0.5s ease 0s;"
											...
											data-lasrc="https://dd992yotdmnlu.cloudfront.net/app/uploads/2021/06/helpdesk_bg-970x1024.jpg"> </div>
								</div>
							</div>
						</div>
					</div>
