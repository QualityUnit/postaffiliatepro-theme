	...
	<div class="Trial__container">
		<div class="Trial__sidebar urlslab-min-width-1024">
			<div class="Trial__sidebar__inner">
				...
				<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/trial_sidebar_affiliate_program.png" alt="<?php _e( 'affiliate program', 'ms' ); ?>" class="urlslab-skip-lazy">
				</div>
			</div>
		</div>
