...
<div class="FullScreen">
	<div class="FullScreen__wrap flex">
		<div class="FullScreen__sidebar">
			<a class="FullScreen__sidebar__logo" href="<?= esc_url( home_url( '/', 'relative' ) ); ?>" title="<?php bloginfo( 'name' ); ?>" onclick="_paq.push(['trackEvent', 'Activity', 'Header', 'Logo'])">
			...
			<p class="FullScreen__sidebar__item__text large">
				<?php _e( 'The Post Affiliate Pro™ platform powers over 30,000 affiliate programs', 'ms' ); ?>
			</p>
			<br />
		...
		<div class="FullScreen__main">
			<div class="FullScreen__main__container">
				<div class="fifty-fifty flex">
					...
					<a href="<?php _e( '/network/trial/', 'ms' ); ?>" class="Button Button--narrow Button--outline Button--outline-light Button--icon">
				...
				<p class="small"><?php _e( "Sign up for Post Affiliate Pro™ in less than 60 seconds. Enjoy testing every feature from our All-Inclusive plan starting today. Once your trial expires, your account's features will be adjusted according to the plan you've selected.", 'ms' ); ?></p>

				<?= do_shortcode( '[signupform-trial]' ); ?>
