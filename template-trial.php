		...
		<div class="Trial__main">
			...
			<div class="Trial__main__inner">
				<div class="Trial__main__tabs flex">
					<a href="<?php esc_attr_e( '/trial/', 'ms' ); ?>" class="Button Button--full Button--narrow Button--icon">
					...
					<a href="<?php esc_attr_e( '/network/trial/', 'ms' ); ?>" class="Button Button--narrow Button--outline Button--outline-light Button--icon">
				...
				<div class="Trial__main__logos">
					<div class="Trial__main__logo">
						<a href="<?php esc_attr_e( '/awards/', 'ms' ); ?>">
