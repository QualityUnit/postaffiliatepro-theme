				...
				allCells.forEach( ( cell ) => {
					...
					if ( hasTooltip.test( text ) ) {
						const infoIcon = `<svg class="icon icon-info-circle">
							<use xlink:href="/app/themes/postaffiliatepro/assets/images/icons.svg#info-circle"></use>
							</svg>`;
					...
					if ( val.textContent === 'y' || val.textContent === 'Yes' ) {
						...
						val.insertAdjacentHTML( 'afterbegin', `
							<svg class="icon icon-check">
								<use xlink:href="/app/themes/postaffiliatepro/assets/images/icons.svg#check"></use>
							</svg>`
						);
					}
					if ( val.textContent === 'n' || val.textContent === 'No' ) {
						...
						val.insertAdjacentHTML( 'afterbegin', `
							<svg class="icon icon-close">
								<use xlink:href="/app/themes/postaffiliatepro/assets/images/icons.svg#close"></use>
							</svg>`
						);
					}
