				...
				<div class="elementor-container elementor-column-gap-default">
						...
						<div class="elementor-widget-image">
							<div class="elementor-widget-container">
								<div class="elementor-image">
									<img src="https://dd992yotdmnlu.cloudfront.net/app/uploads/2019/11/komora.png" alt="<?php _e( 'Peter Komornik', 'ms' ); ?>" loading="lazy">
								</div>
							</div>
						</div>
					</div>
					<div class="elementor-column elementor-col-50 elementor-inner-column Reference__text">
						<div class="elementor-blockquote--skin-clean elementor-blockquote--button-color-official elementor-widget elementor-widget-blockquote">
							...
							<div class="elementor-widget-image">
								<div class="elementor-image">
									<img src="https://dd992yotdmnlu.cloudfront.net/app/uploads/2019/11/logo_slido_black.svg" alt="logo slido black" loading="lazy">
								</div>
							</div>
						</div>
					</div>
