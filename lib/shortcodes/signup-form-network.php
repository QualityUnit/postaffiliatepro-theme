...
function ms_signup_network_form() {
	...
	<?php if ( ICL_LANGUAGE_CODE === 'en' ) { ?>
		<script defer data-src="<?= esc_url( get_template_directory_uri() ) . '/assets/scripts/static/crm_network_en.js' ?>"></script>
	<?php } elseif ( ICL_LANGUAGE_CODE === 'de' ) { ?>
		<script defer data-src="<?= esc_url( get_template_directory_uri() ) . '/assets/scripts/static/crm_network_de.js' ?>"></script>
	<?php } elseif ( ICL_LANGUAGE_CODE === 'es' ) { ?>
		<script defer data-src="<?= esc_url( get_template_directory_uri() ) . '/assets/scripts/static/crm_network_es.js' ?>"></script>
	<?php } elseif ( ICL_LANGUAGE_CODE === 'fr' ) { ?>
		<script defer data-src="<?= esc_url( get_template_directory_uri() ) . '/assets/scripts/static/crm_network_fr.js' ?>"></script>
	<?php } elseif ( ICL_LANGUAGE_CODE === 'pt-br' ) { ?>
		<script defer data-src="<?= esc_url( get_template_directory_uri() ) . '/assets/scripts/static/crm_network_br.js' ?>"></script>
	<?php } elseif ( ICL_LANGUAGE_CODE === 'sk' ) { ?>
		<script defer data-src="<?= esc_url( get_template_directory_uri() ) . '/assets/scripts/static/crm_network_sk.js' ?>"></script>
	<?php } elseif ( ICL_LANGUAGE_CODE === 'hu' ) { ?>
		<script defer data-src="<?= esc_url( get_template_directory_uri() ) . '/assets/scripts/static/crm_network_hu.js' ?>"></script>
	<?php } elseif ( ICL_LANGUAGE_CODE === 'nl' ) { ?>
		<script defer data-src="<?= esc_url( get_template_directory_uri() ) . '/assets/scripts/static/crm_network_nl.js' ?>"></script>
	<?php } elseif ( ICL_LANGUAGE_CODE === 'pl' ) { ?>
		<script defer data-src="<?= esc_url( get_template_directory_uri() ) . '/assets/scripts/static/crm_network_pl.js' ?>"></script>
	<?php } elseif ( ICL_LANGUAGE_CODE === 'it' ) { ?>
		<script defer data-src="<?= esc_url( get_template_directory_uri() ) . '/assets/scripts/static/crm_network_it.js' ?>"></script>
	<?php } else { ?>
		<script defer data-src="<?= esc_url( get_template_directory_uri() ) . '/assets/scripts/static/crm_network_en.js' ?>"></script>
	<?php } ?>
