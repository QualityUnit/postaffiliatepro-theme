...
class Trial_Signup {
	...
	private static function init_defaults() {
		...
		self::$localized_text = array(
			...
			'textProgressInstalling'         => __( 'Installing', 'qu_signup' ),
			...
			'textBuildingTitle'              => __( 'Building Your Post Affiliate Pro...', 'qu_signup' ),
			'textBuildingTitleNetwork'       => __( 'Building Your Post Affiliate Network...', 'qu_signup' ),
			'textBuildingTitleMobile'        => __( 'We are currently building your Post Affiliate Pro dashboard...', 'qu_signup' ),
			'textBuildingTitleMobileNetwork' => __( 'We are currently building your Post Affiliate Network dashboard...', 'qu_signup' ),
			'textBuildingMainText'           => __( 'We appreciate your recent sign up for a Post Affiliate Pro. <br>A message will be sent to your email address containing login details, right after your account is installed. <br>If you wait for a while, after installation is complete you will be able to access your account directly from here.', 'qu_signup' ),
			'textBuildingMainTextNetwork'    => __( 'We appreciate your recent sign up for a Post Affiliate Network. <br>A message will be sent to your email address containing login details, right after your account is installed. <br>If you wait for a while, after installation is complete you will be able to access your account directly from here.', 'qu_signup' ),
			'textBuildingMainTextMobile'     => __( 'After the process is over, we will send the login details to your mailbox.', 'qu_signup' ),
