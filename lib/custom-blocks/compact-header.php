				...
				<div class="compact-header__left">
					...
					if ( is_author() ) {
						if ( ! empty( $author_infos['text'] ) ) {
							...
							<div class="compact-header__text flowhunt-skip" itemprop="description"><?= wp_kses_post( $author_infos['text'] ); ?></div>
						<?php } ?>
						...
						if ( ! empty( $text ) ) {
							?>
							<!-- Description section -->
							<div class="compact-header__text flowhunt-skip"><?= wp_kses_post( $text ); ?></div>
						<?php } ?>
						<!-- Description end -->
					<?php } ?>
