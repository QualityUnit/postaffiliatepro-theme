	...
	function () {
		register_sidebar(
			array(
				...
				'after_widget'  => '<div class="Footer__top__cta"><a href="' . __( '/trial/' ) . '" class="Button Button--full"><span>' . __( 'Start free trial' ) . '</span></a><a href="' . __( '/demo/' ) . '" class="Button Button--outline"><span>' . __( 'Consult an Expert' ) . '</span></a></div></div>',
