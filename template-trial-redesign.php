...
<div class="Trial FullScreen">
	...
	<div class="Trial__container">
		<div class="Trial__sidebar" style="background-image: url(https://dd992yotdmnlu.cloudfront.net/app/uploads/2020/01/bg_trial.jpg);">
			...
			<div class="Trial__sidebar__text">
				...
				<img class="Trial__sidebar__logo" src="https://dd992yotdmnlu.cloudfront.net/app/uploads/2019/11/logo_slido_white.svg" alt="<?php _e( 'Review', 'ms' ); ?>">
			</div>
		</div>
