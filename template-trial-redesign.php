	...
	<div class="Trial__container">
		<div class="Trial__sidebar urlslab-min-width-1024">
			<div class="Trial__sidebar__inner">
				...
				<img src="<?= esc_url( get_template_directory_uri() ); ?>/assets/images/trial_sidebar_affiliate_program_img.png" alt="<?php _e( 'affiliate program', 'ms' ); ?>" class="urlslab-skip-lazy">
				</div>
			</div>
		</div>
		<div class="Trial__main">
			...
			<div class="Trial__main__inner">
				<div class="Trial__main__tabs flex">
					<a href="<?php _e( '/trial-redesign/', 'ms' ); ?>" class="Button Button--full Button--narrow Button--icon">
					...
					<a href="<?php _e( '/network/trial-redesign/', 'ms' ); ?>" class="Button Button--narrow Button--outline Button--outline-light Button--icon">
				...
				<h1 class="Trial__main__title"><?php _e( 'Try 14 Days <span class="highlight-background">Free trial</span>', 'ms' ); ?></h1>
				...
				<div class="Signup__form__labels Trial__labels">
					<div class="Signup__form__labels__label"><?php _e( '14 days free trial', 'ms' ); ?></div>
